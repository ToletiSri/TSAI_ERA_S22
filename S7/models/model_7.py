...
class Net(nn.Module):   
    ...
    def __init__(self):
        ...
        self.conv1 = nn.Sequential(
            ...
            nn.Conv2d(8, 8, 3), #input -8 OUtput-6 RF-18
            nn.ReLU(),
            nn.BatchNorm2d(8),
            nn.Dropout(0.01),
            
            nn.Conv2d(8, 16, 3), #input -6 OUtput-4 RF-22
            nn.ReLU(),
            nn.BatchNorm2d(16),
            nn.Dropout(0.01),
            
            nn.Conv2d(16, 16, 3), #input -4 OUtput-2 RF-26
            nn.ReLU(),           
            nn.BatchNorm2d(16),
            nn.Dropout(0.01),
            
            nn.Conv2d(16, 10, 2), #input -2 OUtput-1 RF-28
            #nn.ReLU(),           
            #nn.BatchNorm2d(16),
                                 
            #nn.Conv2d(16, 10, 1), #input -1 OUtput-1 RF-30, antman-squeeze
            #nn.AvgPool2d(1), #Might not be required
